...
class Config:
    ...
    MAIL_SERVER = "smtp.googlemail.com" # 'smtp.gmail.com' # "localhost" # # os.environ.get('MAIL_SERVER')
    MAIL_PORT = 587 # 465 # 8025 # 
    MAIL_USE_TLS=1
    MAIL_DEFAULT_SENDER = "support@flatlogic.com"
    MAIL_USERNAME = "support@flatlogic.com" # "vladprivalov1990@gmail.com"
    MAIL_PASSWORD="UBU2JGC2wEqc" # "akxum7c91s"
